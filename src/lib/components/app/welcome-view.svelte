...
<div class={cn('', className)}>
  <section class="bg-background flex flex-col items-center justify-center text-center">
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-fg0 mb-4 size-16">
  ...
  <div class="fixed bottom-5 left-0 flex w-full items-center justify-center">
    <p class="text-muted-foreground max-w-prose pt-1 text-xs leading-5 font-normal text-pretty md:text-sm">
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://www.portalos.ru" class="underline">АО Портал</a>.
    </p>
  </div>
</div>
